...
class goods_item extends basefinder
{
    protected $size = 'lg';
     ...
     * @throws \Exception
     */
    public function specvalcreatetable(Request &$request){
        $data = $request->post();
     ...
     * @return array
     */
    public function specvaldeletetable(Request &$request){
        // 后面做如果被使用是禁止删除的
     ...
     * @return array
     */
    public function speccreatetable(Request &$request){
        $input = App::validate()->check($request->post(), [
            'type_id' => 'Required',
            'title' => 'Required',
        ]);
    ...
    public function specdeletetable(Request &$request){
        $input = App::validate()->check($request->post(), [
            'type_id' => 'Required',
            'id' => 'Required',
        ]);
     ...
     * @return mixed
     */
    public function itemtypetable(Request &$request){
     ...
     * @return array
     */
    public function attrspectable(Request &$request){
        $input = App::validate()->check($request->post(), [
            'type_id' => 'Required',
        ]);
     ...
     * @return array
     */
    public function skutable(Request &$request){
