...
use zhanshop\apidoc\create\Schema;
use zhanshop\App;
use zhanshop\Error;
use zhanshop\Helper;
...
class SysMenu extends BaseFinder
{
    ...
    public function puttable(Request &$request, Response &$response)
    {
        ...
        return $this->data(1, 1, [[$this->menuData['pk'], '=', $request->get('pk')]]);
    }
     ...
     * @return array
     */
    public function schematable(Request &$request, Response &$response){
