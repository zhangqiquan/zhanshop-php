;jQuery( function() {
    ...
    ready(function(){
        layui.use(['zhanshop'], function(){
            ...
            zhanshop.ajax(API_ADDRESS+'/v3.0.0/index.index', 'GET', {}, {"token":token}, function(res){
                try{
            ...
            setInterval(function () {
                zhanshop.ajax(API_ADDRESS+'/v3.0.0/index.ping', 'GET', {}, {"token":token}, function(res){},function(xhr){}, false);
            },60000);
