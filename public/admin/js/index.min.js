;jQuery( function() {
    ...
    ready(function(){
        layui.use(['zhanshop'], function(){
            ...
            zhanshop.ajax(API_ADDRESS+'/v4.0.0/index.index', 'GET', {}, {"token":token}, function(res){
                try{
                ...
                if(xhr.responseJSON && xhr.responseJSON.code <= 10001){
            ...
            setInterval(function () {
                zhanshop.ajax(API_ADDRESS+'/v4.0.0/index.ping', 'GET', {}, {"token":token}, function(res){},function(xhr){}, false);
            },60000);
